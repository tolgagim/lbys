        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceTypeRef = table.Column<short>(type: "smallint", nullable: true),
                    SpeCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpeCode2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpeCode3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpeCode4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SpeCode5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Contact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PayPlan = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmsSends", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitSetRef = table.Column<int>(type: "int", nullable: true),
                    UnitSetCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UnitSetName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Barcode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PurchaseVat = table.Column<double>(type: "float", nullable: true),
                    PurchaseBrowse = table.Column<bool>(type: "bit", nullable: true),
                    SellBrowse = table.Column<bool>(type: "bit", nullable: true),
                    SellVat = table.Column<double>(type: "float", nullable: true),
