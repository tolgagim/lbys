...
internal static class Startup
{
    ...
    internal static IServiceCollection AddPersistence(this IServiceCollection services)
    {
        ...
        return services
            .AddDbContext<ApplicationDbContext>((p, m) =>
            {
                ...
                m.ConfigureWarnings(w => w.Ignore(RelationalEventId.PendingModelChangesWarning));
            })

            .AddScoped<IDatabaseInitializer, DatabaseInitializer>()
            .AddScoped<ApplicationDbInitializer>()
            .AddScoped<ApplicationDbSeeder>()
            .AddServices(typeof(ICustomSeeder), ServiceLifetime.Scoped)
            .AddScoped<CustomSeederRunner>()
    ...
    private static IServiceCollection AddRepositories(this IServiceCollection services)
    {
        ...
        services.AddScoped(typeof(IRepositoryWithTransaction<>), typeof(EfRepositoryWithTransaction<>));
