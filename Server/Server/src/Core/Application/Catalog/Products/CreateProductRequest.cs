...
namespace Server.Application.Catalog.Products;
...
public class CreateProductRequestHandler : IRequestHandler<CreateProductRequest, Guid>
{
    ...
    public async Task<Guid> Handle(CreateProductRequest request, CancellationToken cancellationToken)
    {
        ...
        var product = new Product(request.Name,request.Code, request.Description, request.Rate, request.BrandId, productImagePath);
