...
@Component({
  ...
  template: `
    @if(common.showLoading){
      <div style="background-color: #023e6a; width: 100%; height: 100vh; display: flex; align-items: center; justify-content: center;" class="text-center">
      <img src="assets/load.gif" style="max-width: 90%; max-height: 90%; margin: auto;">
  </div>
